\doxysection{signature-\/scheme/include/utils.h File Reference}
\hypertarget{utils_8h}{}\label{utils_8h}\index{signature-\/scheme/include/utils.h@{signature-\/scheme/include/utils.h}}
...
\item 
long \mbox{\hyperlink{utils_8h_a0abfd8660e4c30a446271184dc904c96}{weight}} (nmod\+\_\+mat\+\_\+t array)
\begin{DoxyCompactList}\small\item\em Calculates the Hamming weight of a matrix row. \end{DoxyCompactList}\item 
double \mbox{\hyperlink{utils_8h_a0a93e918b73ae9b05ef7036480bde696}{binary\+\_\+entropy}} (double p)
\begin{DoxyCompactList}\small\item\em Calculates the binary entropy of a probability. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{utils_8h_abe5cbdd0620603e270684a5f978dc6c2}{generate\+\_\+random\+\_\+set}} (unsigned long upper\+\_\+bound, unsigned long size, unsigned long set\mbox{[}size\mbox{]})
\begin{DoxyCompactList}\small\item\em Generates a random set of unique integers within a specified range. \end{DoxyCompactList}\item 
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{utils_8h_a1477b3bbfb233073dd258440041ad129}{generate\+\_\+matrix\+\_\+filename}} (const char \texorpdfstring{$\ast$}{*}prefix, int n, int k, int d)
\begin{DoxyCompactList}\small\item\em Generates a filename for a matrix based on prefix and dimensions. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{utils_8h_ab6d5b54e91321609a751e995f91e457b}{save\+\_\+matrix}} (const char \texorpdfstring{$\ast$}{*}filename, const nmod\+\_\+mat\+\_\+t matrix)
\begin{DoxyCompactList}\small\item\em Saves a matrix to a text file in FLINT format. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{utils_8h_aefef1fc8ea5469aff22fce16404f82d4}{load\+\_\+matrix}} (const char \texorpdfstring{$\ast$}{*}filename, nmod\+\_\+mat\+\_\+t matrix)
\begin{DoxyCompactList}\small\item\em Loads a matrix from a text file in FLINT format. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{utils_8h_a465f5441ca7fc78824e4e834b46a747f}{file\+\_\+exists}} (const char \texorpdfstring{$\ast$}{*}filename)
\begin{DoxyCompactList}\small\item\em Checks if a file exists. \end{DoxyCompactList}\item 
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{utils_8h_aee6a52e0a51200073ab9001de380536c}{generate\+\_\+seed\+\_\+filename}} (const char \texorpdfstring{$\ast$}{*}prefix, int n, int k, int d)
\begin{DoxyCompactList}\small\item\em Generates a filename for a seed based on prefix and parameters. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{utils_8h_a277abfab9e3f799e1d38a673474eea75}{save\+\_\+seed}} (const char \texorpdfstring{$\ast$}{*}filename, const unsigned char \texorpdfstring{$\ast$}{*}seed)
\begin{DoxyCompactList}\small\item\em Saves a seed to a binary file. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{utils_8h_a2c0016f5618e2882d9261251b7fada82}{load\+\_\+seed}} (const char \texorpdfstring{$\ast$}{*}filename, unsigned char \texorpdfstring{$\ast$}{*}seed)
\begin{DoxyCompactList}\small\item\em Loads a seed from a binary file. \end{DoxyCompactList}\item 
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{utils_8h_ab5e8b6289c8d0f065872cbe531443692}{read\+\_\+file}} (const char \texorpdfstring{$\ast$}{*}filename)
\begin{DoxyCompactList}\small\item\em Reads the contents of a file into a string. \end{DoxyCompactList}\item 
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{utils_8h_ae7369b1b9abc62b85ee1e13cf4db0566}{read\+\_\+file\+\_\+or\+\_\+generate}} (const char \texorpdfstring{$\ast$}{*}filename, int msg\+\_\+len)
\begin{DoxyCompactList}\small\item\em Reads a message from file or generates random message. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{utils_8h_a9b8caa6ee7537617613701fce02b972c}{load\+\_\+params}} (struct \mbox{\hyperlink{structcode}{code}} \texorpdfstring{$\ast$}{*}C\+\_\+A, struct \mbox{\hyperlink{structcode}{code}} \texorpdfstring{$\ast$}{*}C1, struct \mbox{\hyperlink{structcode}{code}} \texorpdfstring{$\ast$}{*}C2)
\begin{DoxyCompactList}\small\item\em Loads parameters for codes from a file. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{utils_8h_a086645594d782274944ebe259a8f748d}{ensure\+\_\+matrix\+\_\+cache}} ()
\begin{DoxyCompactList}\small\item\em Ensures matrix cache directory exists. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{utils_8h_aca16e242c76b24e74eddb68763efdead}{ensure\+\_\+output\+\_\+directory}} ()
\begin{DoxyCompactList}\small\item\em Ensures output directory exists. \end{DoxyCompactList}\item 
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{utils_8h_adc1e64667d966146e31b71ac4476d009}{normalize\+\_\+message\+\_\+length}} (const char \texorpdfstring{$\ast$}{*}msg, size\+\_\+t msg\+\_\+len, size\+\_\+t target\+\_\+len, size\+\_\+t \texorpdfstring{$\ast$}{*}final\+\_\+len\+\_\+out)
\begin{DoxyCompactList}\small\item\em Normalizes message length by padding or truncating. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\Hypertarget{utils_8h_a0a93e918b73ae9b05ef7036480bde696}\index{utils.h@{utils.h}!binary\_entropy@{binary\_entropy}}
\index{binary\_entropy@{binary\_entropy}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{binary\_entropy()}{binary\_entropy()}}
{\footnotesize\ttfamily \label{utils_8h_a0a93e918b73ae9b05ef7036480bde696} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_a086645594d782274944ebe259a8f748d}\index{utils.h@{utils.h}!ensure\_matrix\_cache@{ensure\_matrix\_cache}}
\index{ensure\_matrix\_cache@{ensure\_matrix\_cache}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{ensure\_matrix\_cache()}{ensure\_matrix\_cache()}}
{\footnotesize\ttfamily \label{utils_8h_a086645594d782274944ebe259a8f748d} 
...
\end{DoxyReturn}
\Hypertarget{utils_8h_aca16e242c76b24e74eddb68763efdead}\index{utils.h@{utils.h}!ensure\_output\_directory@{ensure\_output\_directory}}
\index{ensure\_output\_directory@{ensure\_output\_directory}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{ensure\_output\_directory()}{ensure\_output\_directory()}}
{\footnotesize\ttfamily \label{utils_8h_aca16e242c76b24e74eddb68763efdead} 
...
\end{DoxyReturn}
\Hypertarget{utils_8h_a465f5441ca7fc78824e4e834b46a747f}\index{utils.h@{utils.h}!file\_exists@{file\_exists}}
\index{file\_exists@{file\_exists}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{file\_exists()}{file\_exists()}}
{\footnotesize\ttfamily \label{utils_8h_a465f5441ca7fc78824e4e834b46a747f} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_a1477b3bbfb233073dd258440041ad129}\index{utils.h@{utils.h}!generate\_matrix\_filename@{generate\_matrix\_filename}}
\index{generate\_matrix\_filename@{generate\_matrix\_filename}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{generate\_matrix\_filename()}{generate\_matrix\_filename()}}
{\footnotesize\ttfamily \label{utils_8h_a1477b3bbfb233073dd258440041ad129} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_abe5cbdd0620603e270684a5f978dc6c2}\index{utils.h@{utils.h}!generate\_random\_set@{generate\_random\_set}}
\index{generate\_random\_set@{generate\_random\_set}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{generate\_random\_set()}{generate\_random\_set()}}
{\footnotesize\ttfamily \label{utils_8h_abe5cbdd0620603e270684a5f978dc6c2} 
...
\end{DoxyEnumerate}
\end{DoxyNote}
\Hypertarget{utils_8h_aee6a52e0a51200073ab9001de380536c}\index{utils.h@{utils.h}!generate\_seed\_filename@{generate\_seed\_filename}}
\index{generate\_seed\_filename@{generate\_seed\_filename}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{generate\_seed\_filename()}{generate\_seed\_filename()}}
{\footnotesize\ttfamily \label{utils_8h_aee6a52e0a51200073ab9001de380536c} 
...
\end{DoxyReturn}
\Hypertarget{utils_8h_aefef1fc8ea5469aff22fce16404f82d4}\index{utils.h@{utils.h}!load\_matrix@{load\_matrix}}
\index{load\_matrix@{load\_matrix}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{load\_matrix()}{load\_matrix()}}
{\footnotesize\ttfamily \label{utils_8h_aefef1fc8ea5469aff22fce16404f82d4} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_a9b8caa6ee7537617613701fce02b972c}\index{utils.h@{utils.h}!load\_params@{load\_params}}
\index{load\_params@{load\_params}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{load\_params()}{load\_params()}}
{\footnotesize\ttfamily \label{utils_8h_a9b8caa6ee7537617613701fce02b972c} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_a2c0016f5618e2882d9261251b7fada82}\index{utils.h@{utils.h}!load\_seed@{load\_seed}}
\index{load\_seed@{load\_seed}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{load\_seed()}{load\_seed()}}
{\footnotesize\ttfamily \label{utils_8h_a2c0016f5618e2882d9261251b7fada82} 
...
\end{DoxyReturn}
\Hypertarget{utils_8h_adc1e64667d966146e31b71ac4476d009}\index{utils.h@{utils.h}!normalize\_message\_length@{normalize\_message\_length}}
\index{normalize\_message\_length@{normalize\_message\_length}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{normalize\_message\_length()}{normalize\_message\_length()}}
{\footnotesize\ttfamily \label{utils_8h_adc1e64667d966146e31b71ac4476d009} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_ab5e8b6289c8d0f065872cbe531443692}\index{utils.h@{utils.h}!read\_file@{read\_file}}
\index{read\_file@{read\_file}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{read\_file()}{read\_file()}}
{\footnotesize\ttfamily \label{utils_8h_ab5e8b6289c8d0f065872cbe531443692} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_ae7369b1b9abc62b85ee1e13cf4db0566}\index{utils.h@{utils.h}!read\_file\_or\_generate@{read\_file\_or\_generate}}
\index{read\_file\_or\_generate@{read\_file\_or\_generate}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{read\_file\_or\_generate()}{read\_file\_or\_generate()}}
{\footnotesize\ttfamily \label{utils_8h_ae7369b1b9abc62b85ee1e13cf4db0566} 
...
\end{DoxyReturn}
\Hypertarget{utils_8h_ab6d5b54e91321609a751e995f91e457b}\index{utils.h@{utils.h}!save\_matrix@{save\_matrix}}
\index{save\_matrix@{save\_matrix}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{save\_matrix()}{save\_matrix()}}
{\footnotesize\ttfamily \label{utils_8h_ab6d5b54e91321609a751e995f91e457b} 
...
\end{DoxyNote}
\Hypertarget{utils_8h_a277abfab9e3f799e1d38a673474eea75}\index{utils.h@{utils.h}!save\_seed@{save\_seed}}
\index{save\_seed@{save\_seed}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{save\_seed()}{save\_seed()}}
{\footnotesize\ttfamily \label{utils_8h_a277abfab9e3f799e1d38a673474eea75} 
...
\end{DoxyReturn}
\Hypertarget{utils_8h_a0abfd8660e4c30a446271184dc904c96}\index{utils.h@{utils.h}!weight@{weight}}
\index{weight@{weight}!utils.h@{utils.h}}
\doxysubsubsection{\texorpdfstring{weight()}{weight()}}
{\footnotesize\ttfamily \label{utils_8h_a0abfd8660e4c30a446271184dc904c96} 
