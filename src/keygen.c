 ...
 * 
 * @param seed A pointer to an unsigned char array where the generated random seed will be stored. The size of this array should be equal to SEED_SIZE, which is defined in the constants header file.
 * 
...
/**
 * @brief Creates a generator matrix object.
 * 
 ...
 * 
 * @param n The total number of columns in the generator matrix. It represents the length of the codewords generated by the matrix.
 * @param k The number of rows in the generator matrix. It represents the dimension of the code, which is the number of information symbols that can be encoded.
 * @param d The minimum distance of the code. This parameter is not directly used in the function but is typically relevant for the properties of the code being generated.
 * @param gen_matrix A pointer to an nmod_mat_t type, which represents the generator matrix to be created. The function initializes this matrix with random entries modulo MOD.
 * @param output_file A pointer to a FILE object where any output or debug information can be written. This parameter is optional and can be used for logging purposes, but in this implementation, it is not used.
 * 
...
/**
 * @brief This function generates a parity check matrix with random entries modulo MOD.
 * 
 ...
 * 
 * @param n The total number of columns in the parity check matrix. It represents the length of the codewords that the matrix checks for validity.
 * @param k The number of rows in the parity check matrix. It represents the dimension of the code, which is the number of information symbols that can be encoded.
 * @param d The minimum distance of the code. This parameter is not directly used in the function but is typically relevant for the properties of the code being generated.
 * @param H A pointer to an nmod_mat_t type, which represents the parity check matrix to be created. The function initializes this matrix with random entries modulo MOD.
 * @param output_file A pointer to a FILE object where any output or debug information can be written. This parameter is optional and can be used for logging purposes, but in this implementation, it is not used.
 * 
...
/**
 * @brief Creates a generator matrix from seed object.
 * 
 ...
 * @param d The minimum distance of the code. This parameter is not directly used in the function but is typically relevant for the properties of the code being generated.
 * @param gen_matrix A pointer to an nmod_mat_t type, which represents the generator matrix to be created. The function initializes this matrix with random entries modulo MOD.
 * @param seed A pointer to an unsigned char array that serves as the seed for the deterministic random number generation. The size of this array should be equal to SEED_SIZE, which is defined in the constants header file.
 * @param output_file A pointer to a FILE object where any output or debug information can be written.
 * 
...
/**
 * @brief Gets or generates matrix with seed object.
 * 
 ...
 * 
 * @param prefix A string that serves as a prefix for the filename of the matrix. This prefix is used to create a unique filename based on the parameters n, k, and d.
 * @param n The total number of columns in the matrix. It represents the length of the codewords generated by the matrix.
 * @param k The number of rows in the matrix. It represents the dimension of the code, which is the number of information symbols that can be encoded.
 * @param d The minimum distance of the code. This parameter is not directly used in the function but is typically relevant for the properties of the code being generated.
 * @param matrix A pointer to an nmod_mat_t type, which represents the matrix to be generated or loaded. The function initializes this matrix with random entries or loads it from a file if it already exists.
 * @param generate_func A pointer to a function that generates a matrix with random entries. This function should take parameters (n, k, d, matrix, output_file) and fill the matrix with random values.
 * @param generate_from_seed_func A pointer to a function that generates a matrix from a seed. This function should take parameters (n, k, d, matrix, seed, output_file) and fill the matrix with values derived from the seed.
 * @param output_file A pointer to a FILE object where any output or debug information can be written. This parameter is optional and can be used for logging purposes, but in this implementation, it is not used.
 * @param regenerate A boolean flag that indicates whether to regenerate the matrix even if it already exists. If set to true, the function will always generate a new matrix; if false, it will load the existing matrix if available.
 * @param use_seed_mode A boolean flag that indicates whether to use seed-based generation for the matrix. If set to true, the function will generate the matrix using a seed; if false, it will generate the matrix randomly.
 * @param seed_out A pointer to an unsigned char array where the generated seed will be stored if seed-based generation is used. The size of this array should be equal to SEED_SIZE, which is defined in the constants header file. If seed-based generation is not used, this parameter can be NULL.
 * 
...
/**
 * @brief A function that generates keys for a signature scheme based on the provided parameters and options.
 * 
 ...
 * 
 * @param C_A A pointer to a struct code object that contains the parameters for the first code, including its length (n), dimension (k), and minimum distance (d). This code is used to generate the parity check matrix H_A.
 * @param C1 A pointer to a struct code object that contains the parameters for the first generator code, including its length (n), dimension (k), and minimum distance (d). This code is used to generate the first generator matrix G1.
 * @param C2 A pointer to a struct code object that contains the parameters for the second generator code, including its length (n), dimension (k), and minimum distance (d). This code is used to generate the second generator matrix G2.
 * @param H_A A pointer to an nmod_mat_t type, which represents the parity check matrix H_A to be generated. The function initializes this matrix with random entries or from a seed, depending on the options provided.
 * @param G1 A pointer to an nmod_mat_t type, which represents the first generator matrix G1 to be generated. The function initializes this matrix with random entries or from a seed, depending on the options provided.
 * @param G2 A pointer to an nmod_mat_t type, which represents the second generator matrix G2 to be generated. The function initializes this matrix with random entries or from a seed, depending on the options provided.
 * @param use_seed_mode A boolean flag that indicates whether to use seed-based generation for the matrices. If set to true, the function will generate the matrices using a seed; if false, it will generate the matrices randomly.
 * @param regenerate A boolean flag that indicates whether to regenerate the matrices even if they already exist. If set to true, the function will always generate new matrices; if false, it will load the existing matrices if available.
 * @param output_file A pointer to a FILE object where any output or debug information can be written. This parameter is optional and can be used for logging purposes, but in this implementation, it is not used.
 * @param h_a_seed A pointer to an unsigned char array where the generated seed for the parity check matrix H_A will be stored if seed-based generation is used. The size of this array should be equal to SEED_SIZE, which is defined in the constants header file. If seed-based generation is not used, this parameter can be NULL.
 * @param g1_seed A pointer to an unsigned char array where the generated seed for the first generator matrix G1 will be stored if seed-based generation is used. The size of this array should be equal to SEED_SIZE, which is defined in the constants header file. If seed-based generation is not used, this parameter can be NULL.
 * @param g2_seed A pointer to an unsigned char array where the generated seed for the second generator matrix G2 will be stored if seed-based generation is used. The size of this array should be equal to SEED_SIZE, which is defined in the constants header file. If seed-based generation is not used, this parameter can be NULL.
 * 
